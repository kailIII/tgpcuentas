...
function Header()
{
    ...
    $this->Cell(10);
    // Título
    $this->Cell(30,30,'* Informe de Cantidad de Cuentas por SAF',0,0,'L');
    $this->Ln(20);
    // Tabla, encabezados de tablas y  color
    $this->Cell(10);
    $this->SetFillColor(215,215,215);
    $this->SetFont('Times','B',10);
    $this->Cell(20,10,'Nro. SAF',1,0,'C',1);
...
for ($i=0; $i < sizeof($cantidadSaf); $i++)
{
    ...
    $pdf->Cell(20,10, $cantidadSaf[$i]["saf"], 1, 0, 'C', 1);
    $pdf->Cell(100,10, $cantidadSaf[$i]["nombre"], 1, 0, 'L', 1);
    $pdf->Cell(20,10, $cantidadSaf[$i]["cantidad"], 1, 0, 'C', 1);
    $pdf->ln(10);       
}
