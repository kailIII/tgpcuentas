...
if ($_SESSION["session_user"] and $_SESSION["session_perfil"]) {
    ...
    if (isset($_POST["Guardar"]) and $_POST["Guardar"] == "Si") {
        ...
        $obj4 = new Firmantes();
        $idsaf = $obj4->idSaf($_POST["saf"]);
        
        $saf = $idsaf[0]["servicio"];
        
       
        $error = $obj3->updateFirmante($_GET["id"], $saf, $_POST["dni"], $_POST["ape_nom"], $_POST["domicilio"], $_POST["cargo"]);
        exit;
    }
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <ul class="breadcrumb" style="margin-bottom: 5px;">
            ...
            <li>FIRMANTES</li>
            <li><a href="buscar_firmantes1.php">BÚSQUEDA DE FIRMANTES</a></li>
      ...
      <?php include ("partes/menu.php"); ?>
        ...
        <div class="panel panel-primary">   
          ...
          <div class="panel-heading">
             <h3 class="panel-title"><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;Modificar Firmante</h3>
          </div>  
          
          <div class="panel-body">
          
                  <form class="form-horizontal" role="form" action="edit_firmante.php?id=<?php echo $id; ?>" method="POST">
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" name="dni" class="form-control" value="<?php echo $firm[0]["dni"];?>" required placeholder="DNI del Firmante" title="Ingrese el DNI">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Apellido y Nombre</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" value="<?php echo $firm[0]["nombre"];?>" placeholder="Apellido y Nombre del Firmante" name="ape_nom" required title="Ingrese el Apellido y nombre">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="col-sm-2 control-label">Domicilio</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" value="<?php echo $firm[0]["domicilio"];?>" placeholder="Domicilio del Firmante" name="domicilio" required title="Ingrese el Domicilio">
                        </div>
                      </div>
                       ...
                       <div class="form-group">
                        <label class="col-sm-2 control-label">Cargo</label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" value="<?php echo $firm[0]["cargo"];?>" placeholder="Cargo del Firmante" name="cargo" required title="Ingrese el Cargo">
                        </div>
                      </div>
                     ...
                     <br>
                      ...
                      <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                          ...
                          <button type="button" class="btn btn-default" onclick="location='buscar_firmantes.php'">Cancelar</button>
