...
if ($_SESSION["session_user"] and $_SESSION["session_perfil"]) {
  ...
  require_once 'class/saf.php';
    ...
    if (isset($_POST["Guardar"]) and $_POST["Guardar"] == "Si") {
        ...
        $obj4->editarCuenta($_GET["id"], $saf, $_POST["sector"], $_POST["denominacion"], $_POST["banco"]);
        exit;
    }
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <ul class="breadcrumb" style="margin-bottom: 5px;">
            ...
            <li class="active">ACTUALIZACIÓN DE CUENTAS OFICIALES</li>
          </ul>
      </div>
      ...
      <?php include ("partes/menu.php"); ?>
        ...
        <div class="panel panel-primary">   
          ...
          <div class="panel-heading">
             <h3 class="panel-title"><span class="glyphicon glyphicon-chevron-right"></span>&nbsp;Actualizaci&oacute;n de Datos de Cuentas Oficiales</h3>
          </div>  
          
          <div class="panel-body">

                  <form class="form-horizontal" role="form" action="e_cuenta.php?id=<?php echo $id; ?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="denominacion" class="form-control" value="<?php echo $row[0]["denominacion"]; ?>" placeholder="Denominación" name="denominacion" required title="Ingrese una Denominaci&oacute;n">
                        </div>
                      </div>
